...
namespace Messenger.Common
{
    ...
    public static class X25519
    {
        ...
        /// </summary>
        public static bool Func(Span<byte> output, Span<byte> scalar, Span<byte> point)
        {
        ...
        /// </summary>
        public static void Func(Span<byte> output, Span<byte> scalar)
        {
        ...
        private static void InternalFunc(Span<byte> output, Span<byte> scalar, Span<byte> point)
        {
